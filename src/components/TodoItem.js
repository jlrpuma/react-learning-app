...
class TodoItem extends React.Component {
    ...
    render() {        
        let taskStyle = {
            color: !this.props.item.status || this.props.item.status === 'NOTDONE' ? 'red' : 'gray',
            fontStyle: this.props.item.status === 'DONE' && "italic",
            textDecoration: this.props.item.status === 'DONE' && "line-through"
        }
